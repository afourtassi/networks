...
return _.object([single.definition], [single.freq_mika])
}, itemData)

//Length 
var value_len  =  map(function(single){
return _.object([single.definition], [single.length])
}, itemData)

//Sem PAC
var value_PAC_assoc  =  map(function(single){
return _.object([single.definition], [single.PAC_assoc])
}, itemData)

//Sem PAT
var value_PAT_assoc  =  map(function(single){
return _.object([single.definition], [single.PAT_assoc])
}, itemData)

//Phono PAC t2
var value_PAC_phono  =  map(function(single){
return _.object([single.definition], [single.PAC_phono_t2])
}, itemData)

//Phono PAT t2
var value_PAT_phono  =  map(function(single){
return _.object([single.definition], [single.PAT_phono_t2])
}, itemData)
...
return _.object([single.definition], [single.learned])
}, itemData)

//now get the "defintions"
var word = map(function(w){_.keys(w)[0]}, value_freq)
