...
Storkel, 2009), we restrict our analysis to the category of
...
generalization was obtained in both the semantic\footnote{One could
  ...
  similarity measure. That said, this apprimation is not perfect; there
  is evidence that a small part of the variance in free assication data
  can be explained by phonological similarity (Kachergis, Cox, \& Jones,
  2011; Matusevych \& Stevenson, 2018), thus leading to possibly minor
  cross-linguistic differences.} and phonological domains.
